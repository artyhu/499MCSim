...
# for data sets with responses (accepted or declined)
...
for i in range(0, 24, 1):
    if rd.iloc[i,2] == 'Declined':
        ...
        graphArr.append(100)
    elif rd.iloc[i,2] == 'Accepted': # because there is no "0" LOC in the excel sheet. This statement isnt great because some may not be accepted or denied 
        graphArr.append(100)
    elif rd.iloc[i,6] == 1:
            graphArr.append(60)
    elif rd.iloc[i,6] == 2:
